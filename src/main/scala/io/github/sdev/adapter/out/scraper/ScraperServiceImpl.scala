...
import io.github.sdev.application.ports.out.ScraperNewsPort
...
object ScraperServiceImpl {

  def make[F[_]: Sync: Logger] =
    new ScraperNewsPort[F] {
      override def scrapNews(siteUrl: String): F[List[News]] = {
